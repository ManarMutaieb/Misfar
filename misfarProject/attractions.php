    ...
    <body>
        <header class="header">
            ...
            if(isset($_SESSION['username'])){
                echo '<div class="back" style="position:absolute;left: 90%;top: 10%">
            <a href="adminHP.php"><span class="material-symbols-sharp">arrow_back</span></a>
            </div>';
            } ?>
        </header>
        ...
        <main>
            <div class="breadcrumb">
                <ol>
                    ...
                    <li>
                        <a href="#" aria-current="page"><?php // display city name in the breadcrumb
    echo $row2['city'];
    ?> Attractions</a>
                    </li>
                </ol>
